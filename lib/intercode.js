...
class Intercode {
    ...
    getUser() {
        ...
        return request(this.accessToken, query);
    }
    ...
    async getRooms() {
        ...
        const result = await request(
            this.accessToken, query, { conventionDomain: getConventionDomain() }
        );
...
async function request(token, query, variables = undefined){
