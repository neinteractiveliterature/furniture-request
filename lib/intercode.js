...
class Intercode {
    ...
    async getLayoutData() {
        const query = gql`query getLayoutHTML($conventionDomain: String!) {
            cmsParent: cmsParentByDomain(domain: $conventionDomain) {
                defaultLayout {
                    navbar_classes
        ...
        return {
            content: result.cmsParent.defaultLayout.content_html_with_placeholders,
            navbarClasses: result.cmsParent.defaultLayout.navbar_classes,
        };
    }
