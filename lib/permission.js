...
function check(req, data, permission){
    ...
    } else if (data.permissions.positions.indexOf('Con Chair') !== -1 || data.permissions.positions.indexOf(' Con Chair') !== -1 || data.permissions.positions.indexOf('Website Team') !== -1 || data.permissions.positions.indexOf('Administrator') !== -1){
        return true;
